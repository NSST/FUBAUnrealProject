...
var AwesomeWaypoint waypoint;
var AwesomeWaypoint CursorDirection;
var bool boo;
...
function SpawnWaypoint()
{
       ...
       {
        waypoint.Destroy();
        waypoint = spawn(class'AwesomeWaypoint', self,,MouseHitWorldLocation);
...
function SpawnCursorDirection()
{
        ...
        if (CursorDirection!= none)
       {
        ...
        CursorDirection = spawn(class'AwesomeWaypoint', self,,MouseHitWorldLocation);
...
{
 loc.Z = 60;
 CursorDirection = spawn(class'AwesomeWaypoint', self,,loc);
 FireRocket();
}
